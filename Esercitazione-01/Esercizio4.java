package esercitazione.lezione1;
...
public class Esercizio4 {
	 ...
	 * AzionatoreCronometro in modo che: ● la digitazione di una stringa
	 * qualsiasi seguita da invio metta in pausa l'orologio e mostri il numero
	 * di secondi trascorsi dall'ultima pausa; ● la digitazione della stringa
	 * ”stop” termini l'orologio e mostri il numero di secondi trascorsi
	 * dall'avvio dell'orologio e il numero delle pause.
	 */

	public static void main(String[] args) {
		Scanner in = new Scanner(System.in);
		CronometroPausa cronometro = new CronometroPausa();
		...
		} while (!cronometro.èInterrotto());

	}

}

class CronometroPausa extends Thread {
